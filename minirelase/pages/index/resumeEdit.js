...
Page({
  ...
  delsub:function(e){
    ...
    let set_resume = self.data.resume
    let type = e.currentTarget.dataset.type ? e.currentTarget.dataset.type : e.target.dataset.type
    let index = e.currentTarget.dataset.index ? e.currentTarget.dataset.index : e.target.dataset.index
    console.log(type,set_resume[type])
    set_resume[type].splice(index,1)
